...
enum UITestFixtures {
    ...
    static let requestsPerUpdate = 8
    ...
    private static func responses(mode: String) -> String {
        ...
        let ids = sample
            ? ["demo-all-country", "demo-sp500", "demo-topix", "demo-nasdaq100", "demo-nikkei225", "demo-gold", "demo-emerging"]
            : ["all-country", "sp500", "topix", "nasdaq100", "nikkei225", "gold", "emerging"]
        let names = sample
        ...
        let contentVersions = ["a", "b", "c", "d", "e", "f", "0"].map { "fund-" + String(repeating: $0, count: 64) }
