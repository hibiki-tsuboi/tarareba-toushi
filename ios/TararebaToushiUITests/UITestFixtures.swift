...
enum UITestFixtures {
    ...
    static let requestsPerUpdate = 6
    ...
    private static func responses(mode: String) -> String {
        ...
        let ids = sample
            ...
            : ["all-country", "sp500", "topix", "nasdaq100", "nikkei225"]
        let names = sample
        ...
        let contentVersions = ["a", "b", "c", "d", "e"].map { "fund-" + String(repeating: $0, count: 64) }
