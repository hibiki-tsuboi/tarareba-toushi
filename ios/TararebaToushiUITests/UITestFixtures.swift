...
enum UITestFixtures {
    ...
    static let requestsPerUpdate = 10
    ...
    private static func responses(mode: String) -> String {
        ...
        let ids = sample
            ? ["demo-all-country", "demo-sp500", "demo-topix", "demo-nasdaq100", "demo-nikkei225", "demo-gold", "demo-emerging", "demo-nanotech", "demo-genomics"]
        ...
        let contentVersions = ["a", "b", "c", "d", "e", "f", "0", "1", "2"].map { "fund-" + String(repeating: $0, count: 64) }
