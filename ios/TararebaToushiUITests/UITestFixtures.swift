...
enum UITestFixtures {
    ...
    static let requestsPerUpdate = 7
    ...
    private static func responses(mode: String) -> String {
        ...
        let ids = sample
            ? ["demo-all-country", "demo-sp500", "demo-topix", "demo-nasdaq100", "demo-nikkei225", "demo-gold"]
            : ["all-country", "sp500", "topix", "nasdaq100", "nikkei225", "gold"]
        let names = sample
        ...
        let contentVersions = ["a", "b", "c", "d", "e", "f"].map { "fund-" + String(repeating: $0, count: 64) }
