...
const cycles = [
    [0.0016, 0.0011, 0.0006, 0.0021, -0.0012],
    [-0.0014, -0.0009, -0.0004, -0.0019, -0.0004],
    [0, 0, 0, 0, 0],
    [0.0018, 0.0014, 0.0007, 0.0022, 0.0026],
];

export function generate({ start = '2020-01-06', end = '2026-09-07', seed = 42, version = 'sample-v4' } = {}) {
